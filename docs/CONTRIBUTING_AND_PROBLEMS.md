# Open Research Problems & Call for Collaboration

The **simulai** framework establishes the foundational thermodynamics of intelligence, but the transition from "Thermal Scaling" to "Cold Intelligence" requires a global effort. We have identified several key open problems where mathematical and computational contributions are needed.
...
## 2. Experimental Verification of the $e$-base Law
**Goal:** Prove that the "effective rank" of optimized neural networks asymptotically approaches $e$.
* **Challenge:** Analyze the pruning masks of models like Llama-3 or GPT-4. Does the average branching factor of the most "active" neurons converge to $e \approx 2.718$?
* **Objective:** Establish the **"Simulai-Base"** as a standard benchmark for neural architecture search (NAS).
...
We welcome contributions from physicists, mathematicians, and AI researchers. 
...
## 📜 Roadmap
- [ ] **Phase I:** Formalize the $e$-base derivation (Completed).
